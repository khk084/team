...
urlpatterns = [
    ...
    path('records/modify/<int:records_id>/', views.records_modify, name='records_modify'),
    path('records/delete/<int:records_id>/', views.records_delete, name='records_delete'),
